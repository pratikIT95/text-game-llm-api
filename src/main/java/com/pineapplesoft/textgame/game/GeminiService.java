...
public class GeminiService {
    private static final String INITIAL_TEXT = "Hello there!";
    ...
    public StoryResponse initiateConversation(String userId){
        ...
        conversationMap.put(userId, GeminiRequest.builder().build());
    ...
    private GeminiRequest createSystemInstruction(){
        return GeminiRequest.builder()
            ...
            .role(USER)
            .parts(List.of(Part.builder().text(INITIAL_TEXT).build())).build()))
            .build();
    }
